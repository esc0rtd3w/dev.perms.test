...
# arm64 can be built as a proper Android PIE binary with Go's internal linker.
CGO_ENABLED=0 GOOS=android GOARCH=arm64 go build -trimpath -o dist/arm64-v8a/apktool
